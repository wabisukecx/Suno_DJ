...
class MainWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        # デッキの高さを調整（HOT CUEボタン追加のため +30px）
        self.deck_a_widget.setMaximumHeight(190)
        self.deck_b_widget.setMaximumHeight(190)
        ...
        # 右側スプリッターの初期サイズ（ライブラリ優先）
        self.right_v_splitter.setSizes([160, 440])
