...
Phase R0変更:
- import先を core.prompt_generator → core.ai.prompt_coordinator に変更
"""

import logging
from PyQt6.QtCore import QThread, pyqtSignal
from core.ai.prompt_coordinator import PromptCoordinator
...
class PromptGeneratorWorker(QThread):
    ...
    def __init__(self, generator: PromptCoordinator, parent=None):
